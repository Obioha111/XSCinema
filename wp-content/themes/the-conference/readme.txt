...
The Conference WordPress Theme, Copyright 2017 raratheme.com
...
== Documentation ==
	...
	* To set up the homepage you must first install and activate the recommended plugins ( RaraTheme Companion ). Then, create a page for the homepage. After that, follow the following steps.
	...
	You are now ready to setup the home page. Go to Appearance> Customize> Frontpage Settings to edit the different frontpage sections. for more documentation visit https://raratheme.com/documentation/the-conference/
